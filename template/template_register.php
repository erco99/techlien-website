        ...
        <form action="utils/user_credential.php" method="POST">
          <div class="form-group centered">
            <div class="col-md-6 mb-3 form-text">
              ...
              <input type="text" name="firstName" class="form-control is-valid" id="inputFirstName" placeholder="es. Mario" required />
            </div>
            <div class="col-md-6 mb-3 form-text">
              <label for="inputLastName">Last Name:</label>
              <input type="text" name="lastName" class="form-control is-valid" id="inputLastName" placeholder="es. Rossi" required />
            </div>
            ...
            <div class="form-group centered">
              <div class="col-sm-12 form-text">
                ...
                <small id="RepeatEmail" class="form-text text-muted"></small>
              </div>
            </div>
            <div class="form-group centered">
              <div class="col-sm-12 form-text">
            ...
            <div class="form-group centered">
              <div class="col-sm-12 form-text">
                ...
                <small id="RepeatPassword" class="form-text text-muted"></small>
              </div>
            </div>
            <div class="form-group centered">
